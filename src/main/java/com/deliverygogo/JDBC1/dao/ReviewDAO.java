...
public class ReviewDAO {
    ...
    public void writeReview(ReviewVO reviewVO) {
        ...
        try {
            ...
            stmt = conn.createStatement();
            pstmt.setInt(1, reviewVO.getREVIEW_NUM());
            pstmt.setString(2, reviewVO.getMENU_NAME());
            pstmt.setString(3, reviewVO.getSCORE());
            pstmt.setString(4, reviewVO.getWRITE_REVIEW());
            pstmt.setString(5, reviewVO.getUSER_ID());
